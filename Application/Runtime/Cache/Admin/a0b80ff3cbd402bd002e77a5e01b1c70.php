...
<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            <?php if(is_array($lists1)): foreach($lists1 as $key=>$menu): ?><li>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <form role="form" action="<?php echo U('Admin/Admin/edit_post');?>" method="post"
                                      class="js-ajax-form">
                                    <input class="form-control" name="id" type="hidden" value="<?php echo ($id); ?>"/>

                                    <div class="form-group">
                                        <label>管理员账号</label>
                                        <input class="form-control" name="user_name" readonly value="<?php echo ($user_name); ?>">

                                        <p class="help-block">请输入管理员账号.</p>
                                    </div>
                                    <div class="form-group">
                                        <label>管理员昵称</label>
                                        <input class="form-control" name="user_nickname" value="<?php echo ($user_nickname); ?>">

                                        <p class="help-block">请输入管理员昵称.</p>
                                    </div>
                                    <div class="form-group">
                                        <label>密码</label>
                                        <input class="form-control" name="user_pass" placeholder="不修改则不填任何信息">
                                    ...
                                    <?php if($id != 1): ?><div class="form-group">
                                            <label>所属组</label>
                                            <select class="form-control" name="role_id">
                                                <?php if(is_array($role_list)): foreach($role_list as $key=>$vo): ?><option value="<?php echo ($vo['id']); ?>"
                                                    <?php if($role_id == $vo['id']): ?>selected<?php endif; ?>
                                                    ><?php echo ($vo['role_name']); ?></option><?php endforeach; endif; ?>
