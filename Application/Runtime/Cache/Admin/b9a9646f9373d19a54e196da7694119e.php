                        ...
                        <div class="dataTable_wrapper">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <?php if(is_array($lists_exists)): foreach($lists_exists as $key=>$vo): ?><tr class="">
                                        ...
                                        <td class="center">
                                            <a href="<?php echo U('Admin/Role/delete_role_auth',['menu_id'=>$vo['id'],'role_id'=>$_GET['id']]);?>"
                        ...
                        <div class="dataTable_wrapper">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <?php if(is_array($lists_not_exists)): foreach($lists_not_exists as $key=>$vo): ?><tr class="">
                                        <td><?php echo ($vo["name"]); ?></td>
                                        <td class="center">
                                            <a href="<?php echo U('Admin/Role/add_role_auth',['menu_id'=>$vo['id'],'role_id'=>$_GET['id']]);?>"
