    ...
    <ul class="nav navbar-top-links navbar-right">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-user">
                ...
                <li class="divider"></li>
                <li><a href="<?php echo U('Admin/Login/loginout');?>"><i class="fa fa-sign-out fa-fw"></i>退出</a>
                </li>
            </ul>
            <!-- /.dropdown-user -->
        </li>
                        ...
                        <div class="dataTable_wrapper">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <?php if(is_array($lists)): foreach($lists as $key=>$vo): ?><tr class="">
                                        ...
                                        <td><?php echo Common\Controller\SysConstController::$sys_status_arr[$vo["status"]]; ?></td>
                                        <td class="center">
                                            <a href="javascript:open_iframe_dialog('<?php echo U('Admin/Role/show_role_user',array('id'=>$vo['id']));?>','<?php echo ($vo['role_name']); ?>');"
                                               class="btn btn-outline btn-btn btn-outline btn-info btn-xs">查看成员</a>

                                            <a href="javascript:open_iframe_dialog('<?php echo U('Admin/Role/show_role_auth',array('id'=>$vo['id']));?>','<?php echo ($vo['role_name']); ?>');"
                                               class="btn btn-outline btn-btn btn-outline btn-info btn-xs">查看权限</a>

                                            <a href="<?php echo U('Admin/Role/edit',['id'=>$vo['id']]);?>"
                                               class="btn btn-outline btn-btn btn-outline btn-info btn-xs">编辑</a>

                                            <a href="<?php echo U('Admin/Role/delete',['id'=>$vo['id']]);?>"
