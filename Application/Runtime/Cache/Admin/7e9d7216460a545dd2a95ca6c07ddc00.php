            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <form role="form" action="<?php echo U('Admin/Role/edit_post');?>" method="post"
                                      class="js-ajax-form">
                                    ...
                                    <div class="form-group">
                                        <label>角色名称</label>
                                        <input class="form-control" name="role_name" value="<?php echo ($role_name); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <p class="help-block">请输入角色功能描述.</p>
                                    </div>
                                    <div class="form-group">
                                        <label>角色状态</label>
                                        ...
                                        <p class="help-block">请设置角色状态.</p>
                                    </div>
                                    <button type="submit" class="btn btn-primary js-ajax-submit">修改</button>
                                    <a class="btn btn-default" href="/weixin/index.php/Admin/Role">返回</a>
